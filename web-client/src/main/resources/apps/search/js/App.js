...
//            }
        ...
        var categoryField = GeoNetwork.util.SearchFormTools.getCategoryField(services.getCategories, '../../images/category/', true);
...
//                constrain: true,
    ...
    function createHeader() {
      ...
      // Ext.getDom('title').innerHTML = '<img class="catLogo" alt="Logo" src="../../images/logos/' + info.siteId + '.gif"/><div><h1>' + info.name + '</h1></div>';
        Ext.getDom('title').innerHTML = '<div><h1>' + info.name + '</h1></div>';
